...
from option_chain_stream.websocket import WebsocketClient
from option_chain_stream.instrument_file import InstrumentMaster
...
class OptionChain:
    ...
    def __init__(
        self, symbol, expiry, api_key, api_secret=None, request_token=None, access_token=None, underlying=False
    ):
        self.symbol = symbol
        self.expiry = expiry
